...
void ETH_GPIO_Config(void)
{
  ...
  /* Configure MCO (PA8) */	//MCO作为50MHz晶振
...
//#elif defined RMII_MODE  /* Mode RMII with STM324xG-EVAL */
	//改为50MH
  SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_RMII); //RMII模式
  RCC_MCO1Config(RCC_MCO1Source_PLLCLK, RCC_MCO1Div_3);//PLL=150M/3=50
//#endif
...
/* Ethernet pins configuration ************************************************/
  ...
  /* Configure PA1, PA2 and PA7 *///RMII_REF_CLK	MDIO	 RMII_CRS_DV
  ...
  /* Configure PC1, PC4 and PC5 *///MDC     RMII_RDX0		 RMII_RDX1
  ...
  /* Configure PB11, PB12 and PB13 *///RMII_TX_EN  RMII_TXD0 RMII_TXD1
